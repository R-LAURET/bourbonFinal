...
?>
    ...
    <div class="container">
        <form action="index.php?action=addClient" method="post" class="form">
            ...
            <div class="form-group">
                <label for="AdrPostale">Adresse postale :</label>
                <input type="text" id="AdrPostale" name="AdrPostale" required>
            </div>
            <div class="form-group">
